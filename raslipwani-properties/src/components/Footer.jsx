      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/raslipwani/" className="text-gray-300 hover:text-white">
                <span className="sr-only">Facebook</span>
                <i className="fab fa-facebook text-xl"></i>
              </a>
              <a href="https://www.instagram.com/raslipwani/" className="text-gray-300 hover:text-white">
                <span className="sr-only">Instagram</span>
                <i className="fab fa-instagram text-xl"></i>
              </a>
              <a href="https://www.tiktok.com/@raslipwani0?_t=ZM-8xJKXLTzNkm&_r=1" className="text-gray-300 hover:text-white">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>
            ...
            <a href="https://voyani.tech" className="text-gray-300 hover:text-white">Voyani</a>
          </p>
        </div>
      </div>
    </footer>
