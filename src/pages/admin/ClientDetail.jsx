...
import { ArrowLeft, Edit2, Building2, Clock, MessageSquare, Home, Activity } from 'lucide-react';
import ClientForm from './ClientForm';
import ClientOverviewPanel from './clients/ClientOverviewPanel';
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <div className="bg-surface-raised rounded-lg shadow">
          ...
          {/* Tab Content */}
          <div className="p-6">
            {activeTab === 'overview' && (              <ClientOverviewPanel client={client} formatCurrency={formatCurrency} />
            )}
