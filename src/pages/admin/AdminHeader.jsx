...
import AdminDesktopNav from './header/AdminDesktopNav';
import AdminMobileMenu from './header/AdminMobileMenu';

/**
 * The admin header. Its two navigations and the nav data are their own modules
 * (Task 27); what stays here is the shell and the state the halves share.
 */
const Header = () => {
  ...
  // Check if we're on admin dashboard - hide Dashboard button only on /admin or /admin/
  const isOnAdminDashboard = location.pathname === '/admin' || location.pathname === '/admin/';
